...
class GreedyBustersAgent(BustersAgent):
    ...
    def __getBestAction(self, closestGhost, legal, pacmanPosition):
        ba, bd = None, 1e18
        for action in legal:
    ...
    def __getClosestGhost(self, pacmanPosition, ep):
        closestGhost, minDist = None, 1e18
        for p in ep:
    ...
    def chooseAction(self, gameState):
        ...
        ep = [pd.argMax() for pd in livingGhostPositionDistributions]
        closestGhost = self.__getClosestGhost(pacmanPosition, ep)
        return self.__getBestAction(closestGhost, legal, pacmanPosition)
