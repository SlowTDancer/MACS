...
class Tokenizer:
    ...
    token_regex = re.compile(
        r'"[^"\n]*"'
        r"|class|constructor|double|function|method|field|static|var|int|char|boolean|void|true|false|null|this|let"
        r"|do|if|else|while|return"
        r"|[{}()\[\].,;+\-*/&|<>=~]"
        r"|\d+"
        r"|\w+"
    )
    ...
    def has_more_tokens(self) -> bool:
        return self.token_counter < len(self.tokens) - 1
