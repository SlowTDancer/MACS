...
from n2t.core.simulator.facade import SimulatorProgram
...
def run_hack_simulator(
    hack_or_asm_file_or_directory: str, cycles: Annotated[int, typer.Option()]
) -> None:
    echo(f"Executing {hack_or_asm_file_or_directory}")
    SimulatorProgram.load_from(hack_or_asm_file_or_directory, cycles).execute()
    echo("Done!")
